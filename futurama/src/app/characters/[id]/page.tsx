...
export default async function CharacterPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <main
            className="grid h-dvh place-items-center font-josefin text-gray-100
            ...
            <Link
                href="/"
                className="self-start p-4 border-4 border-transparent hover:border-gray-100 duration-200 text-5xl">
                Take me back
            </Link>
        </main>
    )
