// Steg 1: Hjälten.
let heroName: string = "The Hero!";
let heroHP: number = 100;
let heroIsAlive: boolean = true;
console.log("Välkommen", heroName, "\nDu börjar med", heroHP, "hp.");

// Steg 2: Inventory.
let heroInventory: string[] = ["Svärd"];
...
// Steg 3: Äventyret.
let enemies: string[] = ["Slempropp", "Varg", "Drake"];
let wolfBite: number = 20;
let dragonFire: number = 25;
